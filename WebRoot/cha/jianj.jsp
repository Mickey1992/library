...
<hr>
 ...
 <p align="center"><strong>（教育部科技查新工作站L19）</strong></p>
		...
		<h3>查收查引流程： </h3>
		<p>1.&nbsp; 委托人提供需检索的论文目录，论文目录应包括：论文作者（第一作者需写全称）、篇名、所发表的期刊名称（若为中文期刊，需增加刊名的英文表达方式）、年、卷、期、页码等信息。 </p>
		<p><strong>备注：由于委托人提供的论文目录错误导致的误检，本查新站不承担责任。</strong> </p>
		<p>2.&nbsp; 委托人确定检索要求和指定要检索的数据库。 </p>
		<p>3.&nbsp; 委托人前往本查新工作站（中山北路 3663 号图书馆逸夫楼一楼 C105 室或闵行校区图书馆二楼 C212 室）提交检索委托，或将委托发送至： chaxin@library.ecnu.edu.cn ，并进行电话确认：62232086 或 54344887 。 </p>
		<p>4.&nbsp; 查新人员完成收录引用检索，并出具签字盖章的检索证明。 </p>
		<p>5.&nbsp; 委托人取检索证明并交纳检索费用。 </p>
