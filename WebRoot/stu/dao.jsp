...
{
addMenuHeader();
addItem("A马克思主义、列宁主义、毛泽东思想、邓小平理论","stu/typeSearch.jsp?type=A","_blank");
addItem("B哲学、宗教","stu/typeSearch.jsp?type=B","_blank");
addItem("C社会科学总论","stu/typeSearch.jsp?type=C","_blank");
addItem("D政治、法律","stu/typeSearch.jsp?type=D","_blank");
addItem("E军事","stu/typeSearch.jsp?type=E","_blank");
addItem("F经济","stu/typeSearch.jsp?type=F","_blank");
addItem("G文化、科学、教育、体育","stu/typeSearch.jsp?type=G","_blank");
addItem("H语言、文字","stu/typeSearch.jsp?type=H","_blank");
addItem("I文学","stu/typeSearch.jsp?type=I","_blank");
addItem("J艺术","stu/typeSearch.jsp?type=J","_blank");
addItem("K历史、地理","stu/typeSearch.jsp?type=K","_blank");
addItem("N自然科学总论","stu/typeSearch.jsp?type=N","_blank");
addItem("O数理科学和化学","stu/typeSearch.jsp?type=O","_blank");
addItem("P天文学、地理科学","stu/typeSearch.jsp?type=P","_blank");
addItem("Q生物科学","stu/typeSearch.jsp?type=Q","_blank");
addItem("R医药、卫生","stu/typeSearch.jsp?type=R","_blank");
addItem("S农业科学","stu/typeSearch.jsp?type=S","_blank");
addItem("T工业技术","stu/typeSearch.jsp?type=T","_blank");
addItem("U交通运输","stu/typeSearch.jsp?type=U","_blank");
addItem("V航空、航天","stu/typeSearch.jsp?type=V","_blank");
addItem("X环境科学、安全科学","stu/typeSearch.jsp?type=X","_blank");
addItem("Z综合性图书","stu/typeSearch.jsp?type=Z","_blank");
addMenuFoot();
